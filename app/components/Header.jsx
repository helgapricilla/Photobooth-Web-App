...
function Header() {
    ...
    return (
        <div className='flex justify-between gap-3 md:gap-2 items-center p-6'>
            ...
            />
            <button
                className='font-semibold p-3 px-6 rounded-full text-[25px] text-white hover:text-gray-800 transition duration-300 transform hover:scale-105'
                style={{ backgroundColor: 'rgb(255, 105, 180)' }}
                onClick={() => router.push('/')}
            >
                Home
            </button>
            ...
            <button
                className='font-semibold p-3 px-6 rounded-full text-[25px] text-white hover:text-gray-800 transition duration-300 transform hover:scale-105'
                style={{ backgroundColor: 'rgb(178, 102, 255)' }}
            ...
            {session?.user ? (
                <Image
                    ...
                    width={60}
                    height={60}
                    className='hover:bg-gray-300 p-2 rounded-full cursor-pointer transition duration-300 transform hover:scale-105'
                />
            ) : (
                <button
                className='font-semibold p-3 px-6 rounded-full text-[25px] text-white hover:text-gray-800 transition duration-300 transform hover:scale-105'
